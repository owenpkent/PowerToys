...
namespace powertoys_gpo
{
    ...
    const std::wstring POLICY_CONFIGURE_ENABLED_DWELL_CLICK = L"ConfigureEnabledUtilityDwellClick";
...
#pragma region UtilityEnabledStatePolicies
    ...
    inline gpo_rule_configured_t getConfiguredDwellClickEnabledValue()
    {
        return getUtilityEnabledValue(POLICY_CONFIGURE_ENABLED_DWELL_CLICK);
    }
